...
<div class="maintextbox">
    <p class="lead text-info" >Results of the conversion</p><hr>
    <table class="conversiondetailstable table table-striped table-hover table-bordered" style="margin-left:0em">    
    <tr>
